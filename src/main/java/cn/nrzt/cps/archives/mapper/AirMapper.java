...
public interface AirMapper {
	...
	List<EDiagnosisCurve> getAllAirdata(String date,String paramid);
	   ...
	   @Select(value = {"<script>SELECT c.*,\r\n" + 
	   		...
	   		" where p.code_type = 'eDeviceType'" 
	    		...
	    		+"AND c.DEVICE_TYPE         =1" 
	    		+"</script>"})
	   @Results(id ="getLitableTempEnergyEquipMap",value={
	...
	List<SMonitorRun> getAllairtable(String bulidingno, String floor, String status, String equipstatus);
	   ...
	   @Select(value = {"<script>SELECT c.*,\r\n" + 
	    		        ...
	    		        +"</script>"})
	   @Results(id ="getLitableTempEnergyEquipData",value={
			   	@Result(column ="MONITOR_ID",property = "monotorId"),
	        	@Result(column ="MONITOR_NAME",property = "monotorName"),
	        	@Result(column ="DEVICE_TYPE",property = "deviceType"),
	        	@Result(column ="NAME",property = "Name"),
	...
	List<SMonitorRun> getAllair(int type);
}
